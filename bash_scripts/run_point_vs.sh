...
#python3 point_vs.py egnn /data/localhost/not-backed-up/durant/CrossDocked2020_parquets/ classifier_output -b 32 -lr 0.0008 -e 10 --activation relu -k 32 --radius 6 --wandb_project PointBAP --compact --weight_decay 1e-4 --train_types /data/localhost/not-backed-up/durant/redocked_types_train.types --min_inactive_rmsd 2 --max_active_rmsd 2 --egnn_residual --egnn_normalise --egnn_tanh --edge_radius 10 --val_on_epoch_end --norm_coords --norm_feats --test_types /data/localhost/not-backed-up/durant/redocked_types_val.types -t /data/localhost/not-backed-up/durant/CrossDocked2020_parquets/ --warm_restarts --egnn_attention --top1 --dropout 0.0 --egnn_classify_on_feats --estimate_bonds --only_save_best_models --layers 48 --wandb_run 48L_compact__0
python3 point_vs.py egnn /data/localhost/not-backed-up/durant/CrossDocked2020_parquets/ classifier_output -b 32 -lr 0.0008 -e 10 --activation relu -k 32 --radius 6 --wandb_project PointBAP --compact --weight_decay 1e-4 --train_types /data/localhost/not-backed-up/durant/redocked_types_train.types  --min_inactive_rmsd 2 --max_active_rmsd 2 --egnn_residual --egnn_normalise --egnn_tanh --edge_radius 10 --val_on_epoch_end --norm_coords --norm_feats --test_types /data/localhost/not-backed-up/durant/redocked_types_val.types  -t /data/localhost/not-backed-up/durant/CrossDocked2020_parquets/ --warm_restarts --egnn_attention --top1 --dropout 0.0 --egnn_classify_on_feats --estimate_bonds --only_save_best_models --layers 48 --wandb_run 48L_compact__0
